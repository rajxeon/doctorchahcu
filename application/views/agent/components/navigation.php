...
<header class="header">
                            ...
                            <ul class="dropdown-menu" style="width:	220px !important" >
                                ...
                                <li style="height:140px !important">
                                    ...
                                    <ul class="menu" >
                                        ...
                                        <li><!-- Task item -->
                                            <a href="#">  <h3> <i class="fa fa-plus"></i> Add Walk-in Interview </h3> </a>
                                        </li>
                                        <li><!-- Task item -->
  ...
  <div class="pull-left info col-xs-12 ">
                         	<form action="<?php echo bu('agent/doctors');?>" method="post" class="sidebar-form" style="margin:0; zoom:.8;margin-top: 9px;">
                        <div class="input-group">
                            <input type="text" name="q" class="form-control" placeholder="Search Doctor" value="<?php echo $this->input->post('q')?>"/>
...
<?php 
//The following code will control the display of menu items based on role
$role=$this->session->userdata('a_role');

$dc_agent=array('dashboard','doctors','profile');
$dc_admin=array('dashboard','doctors','agents','profile');

?>
                    <ul class="sidebar-menu">
                    	<?php 	foreach($$role as $a=>$b):?>
                        <li class="active" data-page="<?=$b;?>">
                                <a href="<?php echo bu('agent/'.$b);?>">
                                    <span><?=ucfirst($b);?></span>
                                </a>
                         </li>
                         <?php endforeach;?>
