...
<!-- Search results -->
    ...
    <!-- Filter Holder -->
     ...
     <?php $this->load->view('components/clinic_filter',$this->data);?>
    ...
    <div class="col-lg-8 col-md-10 col-sm-9 col-xs-12">
        ...
        <div class="row no-pad">
        	<?php $this->load->view('components/clinic_tile',$this->data);?>
        </div>
        <div class="row no-pad">
...
function prepare_instant(self){
		...
		$('.shedule_form').remove();
		bob.slideToggle(200);
		doc_tile=self.closest('.doc_tile');
		 
		
		$('html,body').animate({
        scrollTop: $(doc_tile).offset().top},
        'slow');
		...
		datepicker.datepicker({
			  ...
			  dateFormat: "DD-dd/mm/yy",
				onSelect: function (date) {
					...
					$.post('<?php echo bu('helper/ajax_appoint_sheduler_clinic')?>',{day:date,clinic_id:clinic_id},function(data){
