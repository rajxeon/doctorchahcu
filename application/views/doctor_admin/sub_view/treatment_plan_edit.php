...
<div id="page-wrapper" style=" position:relative;min-height: 100px;"  class="right-side">
  <div class="col-xs-12 page-header">
    ...
    <a href="<?php refferer(bu('doctor/treatment_plans')); ?>"  class="btn btn-sm btn-flat btn-default fr"  style="width:100px"><i class="fa fa-fw fa-times"></i> Cancel </a> </div>
  </div>
  <!-- End of header--> 
...
function prepare_json(self){
	...
	$('.tabber').each(function(index, element) {
		...
		if($(this).find('.completed').length>0) 
		completed	=1;
		else
		completed	=0;
		multiply=0;
