...
function prepare_json(self){
	...
	$('.tabber').each(function(index, element) {
		...
		'total_price':total_price,'note_txt':note_txt,'vig':vig,'vig_txt':vig_txt,'multiply':multiply,'select_all_teeth':select_all_teeth,'completed':completed
		};
		
		array[index]=object;
    });
	$.post('<?php echo bu('doctor/ajax_save_treaatment_plan');?>',{
		doctor_id:doctor_id,
		clinic_id:clinic_id, 
