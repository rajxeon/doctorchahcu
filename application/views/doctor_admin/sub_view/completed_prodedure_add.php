...
<div id="page-wrapper" style=" position:relative;min-height: 100px;"  class="right-side">
  <div class="col-xs-12 page-header">
    <div class="col-xs-2 no-pad"> <a data-toggle="modal" onclick="event.preventDefault();" class="btn btn-default" href="<?php echo bu('doctor/records/0/add_completed_procedure')?>" data-target=".bs-example-modal-lg"> <i class="fa fa-fw fa-users"></i> </a>
    ...
    <a class="btn btn-sm btn-flat btn-primary fr disabled sh_hi" style="width:150px" 
    onclick="event.preventDefault();prepare_json($(this),1)"><i class="fa fa-fw fa-save"></i> Save & Create Invoice</a> 
    </span>
    
    <a href="<?php refferer(bu('doctor/completed_procedure')); ?>"  class="btn btn-sm btn-flat btn-default fr"  style="width:100px"><i class="fa fa-fw fa-times"></i> Cancel </a> </div>
  </div>
  <!-- End of header--> 
...
function prepare_json(self,inv){
	...
	$.post('<?php echo bu('doctor/ajax_save_new_completed_procedure');?>'+'/'+inv,{
		doctor_id:doctor_id,
		clinic_id:clinic_id, 
		...
		console.log(data);
			...
			//window.location.href='<?php refferer(bu('doctor/completed_procedure')); ?>';
			}
...
function show_hide_btn(){ 
	if($('.tabber').length>0) $('.sh_hi').removeClass('disabled');
	else $('.sh_hi').addClass('disabled');
	}
...
//\Funstions that govers the behavoour of counter based on speciality Like 'Show teeth'
function button_by_speciality(speciality){
	switch(speciality){
		case('Dentist'): return '<a href=""  data-vig=""  class="counter_invoker"  onclick="event.preventDefault(); counter_show_teeth($(this))">Show teeth</a>';
  ...
  <div class="col-sm-8 col-xs-12 no-pad">
    <div class="nav-tabs-custom">
      <ul class="nav nav-tabs pull-right">
        <li class="pull-left header"><i class="fa fa-th"></i> Completed Procedure</li>
      </ul>
      <div class="tab-content">
        ...
        <div class="taber_header col-xs-12 no-pad">
          <div class="col-xs-4 no-pad">TREATMENT</div>
           ...
           <div id="bar_holder">
           <button id="sacrificer" class="btn btn-default btn-flat disabled" style="margin:150px auto; display:block">
            	Select a treatment from the right. Multiple items can be added.
            </button>
           </div>
   ...
   <div class="tab_footer bg-primary" align="center">  
        ...
        <div class="col-xs-6" id="add_fund" >By Dr.<?php echo $this->session->userdata('name').' on '.date('d-m-y');?></div>
   </div>
    <!--/Footer --> 
  </div>
