...
.loader_overlay {
  ...
  height: 100vh;margin-top: 50px; margin-left:220px; top:0;
}

.loader_overlay img{ margin-top:20%; margin-left:-220px}
</style>
<div class="loader_overlay hidden-xs hidden-sm hidden-md"><img src="<?php echo bu('images/8.gif');?>"></div>
<script> 
 
	$(window).load(function(e) {$('.loader_overlay').fadeOut(500);})
</script>
 ...
 <!-- add new calendar event modal -->
	...
	<script>
       ...
       <!-- <link href="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-datepicker/1.4.0/css/bootstrap-datepicker.min.css" rel="stylesheet" />-->
        ...
        <script  async="async" src="<?php echo base_url().'/';?>js/AdminLTE/appss.js" type="text/javascript"></script>
